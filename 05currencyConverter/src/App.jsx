...
function App() {
  ...
  const CurrencyRates = useCurrencyRates(from)
  ...
  return (
    <>
      <h1 className='text-3xl bg-orange-300 text-black py-3'>Currency Converter</h1>
          ...
          <div className='w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 background-blur-sm bg-white/30 '>
            <form onSubmit={(e)=>{
              ...
              <div className='relative w-full h-0.5'>
                <button type='button' onClick={swap} className='absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-sm bg-blue-600 text-white px-2 py-0.5'>
                  Swap
                </button>
              </div>
              <div className='w-full mb-1'>
